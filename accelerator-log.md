...
```json
{
  ...
  "projectName" : "spring-petclinic-kind"
}
```
## Log
```
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [spring-petclinic->spring-petclinic-kin...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: spring-petclinic->: spring-petclinic-k...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [spring-petclinic template repo->spring-petclinic-kin...(truncated)]
